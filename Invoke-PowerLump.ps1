...
function Invoke-PowerLump
{
  ...
  .EXAMPLE
   ...
   .NOTES
     PowerLump script by Kathy Peters, Josh Kelley (winfang) and Dave Kennedy (ReL1K)
...
"@
        ...
        function Get-RegKeyClass([string]$key, [string]$subkey)
        {
            ...
            $result = "";
            [int]$hkey=0
            if (-not [PowerLump.Native]::RegOpenKeyEx($nkey,$subkey,0,$KEYREAD,[ref]$hkey))
            {
                $classVal = New-Object Text.Stringbuilder 1024
                [int]$len = 1024
                if (-not [PowerLump.Native]::RegQueryInfoKey($hkey,$classVal,[ref]$len,0,[ref]$null,[ref]$null,
                ...
                [PowerLump.Native]::RegCloseKey($hkey) | Out-Null
            }
            else
            {
        ...
        {
            Write-Error "Admiem privileges necesry."
        }
}
